...
import net.lowis.tutorialmod.entity.custom.MantisVariant;
...
public class MantisRenderer extends MobEntityRenderer<MantisEntity, MantisModel<MantisEntity>> {
    ...
    private static final Map<MantisVariant, Identifier> LOCATION_BY_VARIANT = Util.make(Maps.newEnumMap(MantisVariant.class), map -> {
       map.put(MantisVariant.DEFAULT, Identifier.of(TutorialMod.MOD_ID, "textures/entity/mantis/mantis.png"));
       map.put(MantisVariant.ORCHID, Identifier.of(TutorialMod.MOD_ID, "textures/entity/mantis/mantis_orchid.png"));
    });
