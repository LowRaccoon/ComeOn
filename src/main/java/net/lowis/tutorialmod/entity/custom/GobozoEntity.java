...
public class GobozoEntity extends AnimalEntity {

    public final AnimationState idleAnimationState = new AnimationState();
    private int idleAnimationTimeout = 0;

    public GobozoEntity(EntityType<? extends AnimalEntity> entityType, World world) {
    ...
    public @Nullable PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        return ModEntities.GOBOZO.create(world);
    }
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(2, new TemptGoal(this, 1.15D, Ingredient.ofItems(ModItems.CAULIFLOWER), false));
