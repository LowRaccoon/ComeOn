...
import net.lowis.tutorialmod.entity.custom.ChairEntity;
...
public class ChairBlock extends HorizontalFacingBlock {
    ...
    public BlockState onBreak(World world, BlockPos pos, BlockState state, PlayerEntity player) {
        ...
        if(entity instanceof ChairEntity &&
                (int)player.getX() == pos.getX() &&              //E CAMBIATO 01.03.25
                (int)player.getY() + 1 == pos.getY() &&          //
                (int)player.getZ() - 1 == pos.getZ()) {          //
            player.stopRiding();
        }
